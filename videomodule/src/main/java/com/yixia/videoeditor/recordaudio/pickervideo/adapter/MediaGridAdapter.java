package com.yixia.videoeditor.recordaudio.pickervideo.adapter;
...
public class MediaGridAdapter extends RecyclerView.Adapter<MediaGridAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.check_image.setImageDrawable(isSelect >= 0 ? ContextCompat.getDrawable(context, R.mipmap.btn_selected) : ContextCompat.getDrawable(context, R.mipmap.btn_unselected));
            ...
            public void onClick(View v) {
                ...
                if (selectMedias.size() >= maxSelect && isSelect < 0) {
                    ...
                    if (media.size > maxSize) {
                        ...
                        holder.check_image.setImageDrawable(isSelect >= 0 ? ContextCompat.getDrawable(context, R.mipmap.btn_unselected) : ContextCompat.getDrawable(context, R.mipmap.btn_selected));
